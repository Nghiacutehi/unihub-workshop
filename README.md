...
```bash
├── blueprint/       # [NỘP BÀI] Toàn bộ thiết kế hệ thống, sơ đồ C4 và các đặc tả Specs
├── data/            # Chứa file SQL Init Database và Dữ liệu CSV mẫu để Import
├── src/
│   ├── backend/     # Backend Golang (REST API, Goroutine Workers, RabbitMQ Consumer)
│   ├── web/         # Web App cho Sinh viên & Admin (Next.js, TailwindCSS)
│   └── mobile/      # Mobile App cho Staff (React Native / Expo, SQLite Offline)
```
...
---
*Đồ án Môn học Thiết kế Phần mềm — Phát triển bởi nhóm Nxx.*
